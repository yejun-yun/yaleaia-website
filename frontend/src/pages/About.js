    ...
    <div className="about">
      <section className="join-cta">
        <div className="container">
          ...
          <p>Thus, we believe managing risks from advanced artificial intelligence is one of the most important problems of our time. We are a community at Yale aimed at reducing these risks and steering the trajectory of AI development for the better. In addition to running our Technical AI Safety Fellowship, we run a paper reading group, host workshops and socials, and engage the Yale community with discussion about AI safety.</p>
