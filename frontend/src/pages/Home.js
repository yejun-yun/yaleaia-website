      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">We run an 8-week AI Safety Fellowship on technical AI safety research, covering topics like neural network interpretability, learning from human feedback, goal misgeneralization in reinforcement learning agents, eliciting latent knowledge, and evaluating dangerous capabilities in models.</p>
